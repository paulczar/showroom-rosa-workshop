...
oc -n bookinfo apply -f \
  https://raw.githubusercontent.com/rhpds/showroom-rosa-workshop/refs/heads/main/rosa-content/assets/scripts/bookinfo.yaml
----
+
.Sample Output
[source,text,options=nowrap]
...
Check it out on GitHub https://github.com/rhpds/showroom-rosa-workshop/blob/main/rosa-content/assets/scripts/bookinfo.yaml[here,window=_blank].
...
----
oc -n bookinfo apply -f \
  https://raw.githubusercontent.com/rhpds/showroom-rosa-workshop/refs/heads/main/rosa-content/assets/scripts/bookinfo-gateway.yaml
----
+
.Sample Output
[source,text,options=nowrap]
...
----
oc -n bookinfo apply -f \
  https://raw.githubusercontent.com/rhpds/showroom-rosa-workshop/refs/heads/main/rosa-content/assets/scripts/destination-rule-all.yaml
----
+
.Sample Output
[source,text,options=nowrap]
