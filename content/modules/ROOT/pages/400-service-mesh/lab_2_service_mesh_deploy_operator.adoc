...
* *Red Hat OpenShift Service Mesh 2* - Allows you to connect, secure, control, and observe the microservices that comprise your applications.  **Note this workshop is designed to work with Service Mesh 2, do not be tempted to install Service Mesh 3.**
